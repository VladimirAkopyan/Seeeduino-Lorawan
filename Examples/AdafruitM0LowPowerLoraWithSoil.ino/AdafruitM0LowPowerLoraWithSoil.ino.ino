...
const unsigned int Interval_Sleep = 600; //How long device will sleep for
...
void readValues(unsigned char *vals) {
    ...
    vals[1] = (capacitance >> (8*0)) & 0xff;;
    vals[2] = (capacitance >> (8*1)) & 0xff;;
    Serial.print(", Temperature: ");
    int temp = soilSensor.getTemperature(); 
    Serial.println(temp/(float)10); //temperature register
    vals[3] = (temp >> (8*0)) & 0xff;
    vals[4] = (temp >> (8*1)) & 0xff;
